        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-12">
          ...
          <div className='flex-1 w-full'>
            <form className='space-y-4'>
              ...
              <button onClick={()=>{alert("Sorry! Please send me on this email btarak398@gmail.com")}}className='bg-gradient-to-r from-green-400 to-blue-500 text-white  md:inline
